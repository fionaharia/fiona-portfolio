...
const AnimatedBlobs = () => {
  return (
    <div className="flex pl-40 md:pl-0 justify-center items-center h-screen overflow-hidden">
      ...
      <div className="absolute w-36 h-36 md:w-64 md:h-64 2xl:w-80 2xl:h-80 bg-yellow-400 dark:bg-purple-500 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000 md:top-0 md:left-[40%] 2xl:left-[60%] 2xl:top-[30%] left-[80%] top-[30%]"></div>
